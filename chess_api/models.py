...
class ChessGame(models.Model):
    ...
    board_state = models.TextField(default=chess.Board().fen())  # a text field to store the FEN (Forsyth-Edwards Notation) of the current board state
    moves = ArrayField(models.CharField(max_length=10), blank=True, null=True, default=[])  # an array to store the moves as 'e2e4' etc.
